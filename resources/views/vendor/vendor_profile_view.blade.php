    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <form action="{{route('vendor#profileStore')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$vendorData->name}}" />
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$vendorData->email}}" />
                                        @error('email')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$vendorData->phone}}" />
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{-- <input type="text" name="address" class="form-control @error('address') is-invalid
                                        @enderror " value="{{$vendorData->address}}" /> --}}
                                        <select name="vendor_join" class="form-select mb-3" value="{{$vendorData->vendor_join}}" aria-label="Default select example">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{-- <input type="text" name="address" class="form-control @error('address') is-invalid
                                        @enderror " value="{{$vendorData->address}}" /> --}}
                                        <textarea name="vendor_short_info" class="form-control" id="inputAddress" cols="30" rows="10" placeholder="Vendor Info"  >{{$vendorData->vendor_short_info}}</textarea>
                                        @error('address')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
