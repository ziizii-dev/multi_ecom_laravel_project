...
<header>
    ...
    class="msg-time float-end">2 hrs ago</span></h6>
        <p class="msg-info">Your new product has approved</p>
            ...
            <img src="{{(!empty($adminData->photo))? url('upload/admin_images/'.$adminData->photo) : url('upload/no_image.jpg')}}" alt="Admin" style="width:60px;height:60px" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
