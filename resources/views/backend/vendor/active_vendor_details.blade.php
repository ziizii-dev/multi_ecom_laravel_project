    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <form action="{{route('inactive#vendorApprove')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$activeVendorDetails->name}}" />
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$activeVendorDetails->email}}" />
                                        @error('email')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$activeVendorDetails->phone}}" />
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value="{{$activeVendorDetails->address}}" />
                                        @error('address')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="vendor_join" class="form-control @error('vendor_join') is-invalid
                                        @enderror " value="{{$activeVendorDetails->vendor_join}}" />
                                        @error('vendor_join')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{-- <input type="text" name="address" class="form-control @error('address') is-invalid
                                        @enderror " value="{{$vendorData->address}}" /> --}}
                                        <textarea name="vendor_short_info" class="form-control" id="inputAddress" cols="30" rows="10" placeholder="Vendor Info"  >{{$activeVendorDetails->vendor_short_info}}</textarea>
                                        @error('address')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
