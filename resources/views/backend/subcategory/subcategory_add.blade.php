                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " value=" " /> --}}
                                        <select name="category_id" class="form-select form-select-lg mb-3  @error('category_id') is-invalid
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="subcategory_name" class="form-control @error('subcategory_name') is-invalid
                                        @enderror " value=" " />
