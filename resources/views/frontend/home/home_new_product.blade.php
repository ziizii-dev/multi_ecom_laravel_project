@php
    $products = App\Models\Product::where('delete_status',1)->where('status',1)->orderBy('id','ASC')->limit(10)->get();
        ...
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            ...
            <ul class="nav nav-tabs links" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <a href="#categoryBtn{{$category->id}}" class="nav-link" id="nav-tab-two" data-bs-toggle="tab" type="button" role="tab" aria-controls="tab-two" aria-selected="false"> {{$category->category_name}}</a>
                </li>
                @endforeach
...
<!--end product card-->
            ...
            <!--En tab one-->
            @foreach ($categories as $category )
            <div class="tab-pane fade" id = "categoryBtn{{$category->id}}" role="tabpanel" aria-labelledby="tab-two">
                <div class="row product-grid-4">
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            <div class="product-img-action-wrap">
                                ...
                                <div class="product-action-1">
                                    <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"  id="{{$product->id}}"
